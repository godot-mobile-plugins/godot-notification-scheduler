...
│   ├── notification_scheduler_plugin.xcodeproj/     # Xcode project
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-notification-scheduler/main/addon/src/icon.png" width="20"> Android SDK Configuration
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/godot-mobile-plugins/godot-notification-scheduler.git
   cd godot-notification-scheduler
   ```
...
- **Release archive:** `common/build/archive/NotificationSchedulerPlugin-Android-v*.zip`
...
- **Release archive:** `ios/build/release/NotificationSchedulerPlugin-iOS-v*.zip`
...
# View logs
adb logcat | grep -i NotificationScheduler
```
...
This creates:
- `release/NotificationSchedulerPlugin-Android-v*.zip`
- `release/NotificationSchedulerPlugin-iOS-v*.zip`
- `release/NotificationSchedulerPlugin-Multi-v*.zip` (combined)
...
./script/install.sh -t /path/to/your/project -z /path/to/NotificationSchedulerPlugin-*.zip

# Example
./script/install.sh -t ~/MyGame -z release/NotificationSchedulerPlugin-Multi-v6.0.zip
```
...
- Check existing [GitHub Issues](https://github.com/godot-mobile-plugins/godot-notification-scheduler/issues)
- Check exısting [GitHub Discussions](https://github.com/godot-mobile-plugins/godot-notification-scheduler/discussions)
